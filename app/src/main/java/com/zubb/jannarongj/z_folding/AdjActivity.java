...
public class AdjActivity extends Activity {
    ...
    String rmd_plant,g_barid,srmdmat,prmdmat,grademat,upmat,r_rmd_date,scanresult,rmd_qa_grade,rmd_size,rmd_date,rmd_hn,rmd_remark,rmd_period,rmd_length,rmd_grade,rmd_spec,matcode,rmd_id,rmd_no,rmd_charge,rmd_bundle,item_barcode;
    ...
    public void onAdjTypeClick(View v){
       ...
       // String[] values  = new String[] {"ปรับเพื่อขาย","ปรับล่วงหน้า","ปรับเส้นขาด-เกิน","ปรับน้ำหนักขาด-เกิน","ปรับสินค้าขึ้นสลับ","ปรับเข้า QI รอตรวจ","ปรับออก QI ตรวจซ้ำแล้ว","ปรับเกรด","ปรับเหล็กพับ","ปรับรวมมัด"};
        ...
        int[] views = {R.id.t1};
        final SimpleAdapter ADA = new SimpleAdapter(AdjActivity.this,
                rmlist.getLocation(rmd_plant), R.layout.adp_list_adj, from,
                views){
