...
public class CheckVersion extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ip!= null && ip.substring(8,11).equals("171")){

        }else if(ip!= null && ip.substring(8,11).equals("116")){

           /* connectionClass.setUdbn("PP");
            connectionClass.setUip("192.168.116.222");
            connectionClass.setUpass("sipco77");
*/
        }else if(ip!= null && ip.substring(8,11).equals("117")){

        }else if(ip!= null && ip.substring(8,11).equals("118")){

        }else if(ip!= null && ip.substring(8,11).equals("192")){

        }else if(ip!= null && ip.substring(8,11).equals("193")){

        }else if(ip!= null && ip.substring(8,11).equals("194")){
            connectionClass.setUdbn("PP");
            connectionClass.setUip("192.168.100.222");
            connectionClass.setUpass("");
        }else if(ip!= null && ip.substring(8,11).equals("140")){
            connectionClass.setUdbn("PP");
            connectionClass.setUip("192.168.100.222");
            connectionClass.setUpass("");
        }
    ...
    class DownloadNewVersion extends AsyncTask<String,Integer,Boolean> {
        ...
        protected Boolean doInBackground(String... arg0) {
            ...
            try {
                ...
                Log.e("EUDP", "Update Error: " + e.getMessage());
                flag = false;
            }
            return flag;
